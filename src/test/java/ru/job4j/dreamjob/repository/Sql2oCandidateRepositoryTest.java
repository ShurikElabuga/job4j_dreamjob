...
import ru.job4j.dreamjob.repository.candidate.Sql2oCandidateRepository;
...
class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveSeveralThenGetAll() {
        var creationDate = now().truncatedTo(ChronoUnit.MINUTES);
        var candidate1 = sql2oCandidateRepository.save(new Candidate(0, "title1", "description1", creationDate, true, 1, file.getId()));
        var candidate2 = sql2oCandidateRepository.save(new Candidate(0, "title2", "description2", creationDate, false, 1, file.getId()));
        var candidate3 = sql2oCandidateRepository.save(new Candidate(0, "title3", "description3", creationDate, true, 1, file.getId()));
